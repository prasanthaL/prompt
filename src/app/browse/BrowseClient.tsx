...
export default function BrowseClient({ initialPrompts }: BrowseClientProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between animate-fade-in">
      ...
      {/* Footer */}
      <footer className="py-20 px-4 md:px-8 border-t border-white/[0.08] bg-[#070610]/40 backdrop-blur-md w-full">
        ...
        <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-white/[0.08] flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-white/20">
